...
const getRandomNumber = (num) => {return Math.floor(Math.random() * (num + 1));};
  ...
  noButton.addEventListener("click", () => {
    ...
    if (noClickCount < 4) {
      ...
      //no button text
      const messages = ["No","Are you sure?","Awwww please?","Don't do this to me :(","Say yes or else...",];
  ...
  yesButton.addEventListener("click", () => {
    ...
    valentineQuestion.innerHTML = `
      <img src="./images/200.gif" alt="Celebration duckie" style="display: block; margin: 0 auto; width: 200px; height: auto;"/>
      Congratulations!!<br>
